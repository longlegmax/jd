...
let $ = {};
let cookie = '', cookiesArr = [], validate = '';
...
function exchange(beanId) {
    ...
    return new Promise(async (resolve) => {
        ...
        let { data } = await axios.post(`https://jdjoy.jd.com/common/gift/new/exchange?reqSource=h5&invokeKey=NRp8OPxZMFXmGkaE&validate=${validate}`, JSON.stringify({ "buyParam": { "orderSource": 'pet', "saleInfoId": beanId }, "deviceInfo": {} }), {
            headers: {
                "Host": "jdjoy.jd.com",
